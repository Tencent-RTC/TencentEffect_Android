...
public class TEBeautyTemplateEditProvider extends TEAbstractPanelDataProvider {
    ...
    public List<TEUIProperty.TESDKParam> getRevertData(Context context) {
        ...
        // Since the restoration requires restoring both the effect and the selected state of the panel to the original data state, originalParamList is used to restore the selected state of the panel.
