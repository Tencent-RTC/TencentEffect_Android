...
public class TEPanelMenuView extends FrameLayout implements View.OnClickListener {
    ...
    private void initViews(Context context) {
        ...
        this.switchLayout.setText(getResources().getString(R.string.te_beauty_panel_view_expand_original_txt), getResources().getString(R.string.te_beauty_panel_view_expand_te_txt));
     ...
     * 设置可以被点击的菜单
     *
     * @param panelDataType MOTION,BEAUTY,MAKEUP,LUT,只能对这四个按钮设置不可点击
     */
