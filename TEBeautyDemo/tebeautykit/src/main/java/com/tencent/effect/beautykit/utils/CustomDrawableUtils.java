...
public class CustomDrawableUtils {
        ...
        public static LayerDrawable createSeekBarThumbDrawable(Context context, @ColorInt int color) {
            ...
            LayerDrawable layerDrawable = new LayerDrawable(new GradientDrawable[]{backgroundDrawable, progressDrawable});
            layerDrawable.setId(0, android.R.id.background);
            layerDrawable.setId(1, android.R.id.progress);
            layerDrawable.setLayerInset(1, ScreenUtils.dp2px(context, 3), ScreenUtils.dp2px(context, 3), ScreenUtils.dp2px(context, 3), ScreenUtils.dp2px(context, 3));
