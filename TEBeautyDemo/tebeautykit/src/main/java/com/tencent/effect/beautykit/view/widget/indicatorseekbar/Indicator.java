...
public class Indicator {
    ...
    private GradientDrawable getGradientDrawable() {
        ...
        if (mIndicatorType == IndicatorType.ROUNDED_RECTANGLE) {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.te_beauty_isb_indicator_rounded_corners);
        } else {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.te_beauty_isb_indicator_square_corners);
        }
