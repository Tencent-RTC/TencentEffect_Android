...
public class IndicatorSeekBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mIsFloatProgress = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_progress_value_float, indicatorSeekBarParams.progressValueFloat);
        mUserSeekable = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_user_seekable, indicatorSeekBarParams.userSeekable);
        mClearPadding = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_clear_default_padding, indicatorSeekBarParams.clearPadding);
        mOnlyThumbDraggable = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_only_thumb_draggable, indicatorSeekBarParams.onlyThumbDraggable);
        mSeekSmoothly = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_seek_smoothly, indicatorSeekBarParams.seekSmoothly);
        mR2L = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_r2l, indicatorSeekBarParams.r2l);
        //track
        mBackgroundTrackSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_track_background_size, indicatorSeekBarParams.trackBackgroundSize);
        mProgressTrackSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_track_progress_size, indicatorSeekBarParams.trackProgressSize);
        mBackgroundTrackColor = ta.getColor(R.styleable.TE_IndicatorSeekBar_isb_track_background_color, indicatorSeekBarParams.trackBackgroundColor);
        mProgressTrackColor = ta.getColor(R.styleable.TE_IndicatorSeekBar_isb_track_progress_color, indicatorSeekBarParams.trackProgressColor);
        mTrackRoundedCorners = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_track_rounded_corners, indicatorSeekBarParams.trackRoundedCorners);
        //thumb
        mThumbSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_thumb_size, indicatorSeekBarParams.thumbSize);
        ...
        initThumbColor(ta.getColorStateList(R.styleable.TE_IndicatorSeekBar_isb_thumb_color), indicatorSeekBarParams.thumbColor);
        //thumb text
        mShowThumbText = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_show_thumb_text, indicatorSeekBarParams.showThumbText);
        mThumbTextColor = ta.getColor(R.styleable.TE_IndicatorSeekBar_isb_thumb_text_color, indicatorSeekBarParams.thumbTextColor);
        //tickMarks
        mTicksCount = ta.getInt(R.styleable.TE_IndicatorSeekBar_isb_ticks_count, indicatorSeekBarParams.tickCount);
        mShowTickMarksType = ta.getInt(R.styleable.TE_IndicatorSeekBar_isb_show_tick_marks_type, indicatorSeekBarParams.showTickMarksType);
        mTickMarksSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_tick_marks_size, indicatorSeekBarParams.tickMarksSize);
        initTickMarksColor(ta.getColorStateList(R.styleable.TE_IndicatorSeekBar_isb_tick_marks_color), indicatorSeekBarParams.tickMarksColor);
        mTickMarksDrawable = ta.getDrawable(R.styleable.TE_IndicatorSeekBar_isb_tick_marks_drawable);
        mTickMarksSweptHide = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_tick_marks_swept_hide, indicatorSeekBarParams.tickMarksSweptHide);
        mTickMarksEndsHide = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_tick_marks_ends_hide, indicatorSeekBarParams.tickMarksEndsHide);
        //tickTexts
        mShowTickText = ta.getBoolean(R.styleable.TE_IndicatorSeekBar_isb_show_tick_texts, indicatorSeekBarParams.showTickText);
        mTickTextsSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_tick_texts_size, indicatorSeekBarParams.tickTextsSize);
        initTickTextsColor(ta.getColorStateList(R.styleable.TE_IndicatorSeekBar_isb_tick_texts_color), indicatorSeekBarParams.tickTextsColor);
        mTickTextsCustomArray = ta.getTextArray(R.styleable.TE_IndicatorSeekBar_isb_tick_texts_array);
        initTextsTypeface(ta.getInt(R.styleable.TE_IndicatorSeekBar_isb_tick_texts_typeface, -1), indicatorSeekBarParams.tickTextsTypeFace);
        //indicator
        mShowIndicatorType = ta.getInt(R.styleable.TE_IndicatorSeekBar_isb_show_indicator, indicatorSeekBarParams.showIndicatorType);
        mIndicatorColor = ta.getColor(R.styleable.TE_IndicatorSeekBar_isb_indicator_color, indicatorSeekBarParams.indicatorColor);
        mIndicatorTextSize = ta.getDimensionPixelSize(R.styleable.TE_IndicatorSeekBar_isb_indicator_text_size, indicatorSeekBarParams.indicatorTextSize);
        mIndicatorTextColor = ta.getColor(R.styleable.TE_IndicatorSeekBar_isb_indicator_text_color, indicatorSeekBarParams.indicatorTextColor);
        int indicatorContentViewId = ta.getResourceId(R.styleable.TE_IndicatorSeekBar_isb_indicator_content_layout, 0);
        if (indicatorContentViewId > 0) {
            mIndicatorContentView = View.inflate(mContext, indicatorContentViewId, null);
        }
        int indicatorTopContentLayoutId = ta.getResourceId(R.styleable.TE_IndicatorSeekBar_isb_indicator_top_content_layout, 0);
