...
public class PanelItemSelectorLayout extends LinearLayout {
    ...
    private float cornerRadius = -1; // 圆角半径
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray attributes = getContext().obtainStyledAttributes(attrs, R.styleable.te_beauty_panel_item_selector);
            this.cornerRadius = attributes.getDimension(R.styleable.te_beauty_panel_item_selector_corner_radius, defaultRadius);
            this.smallRectLeftMargin = attributes.getDimension(R.styleable.te_beauty_panel_item_selector_rect_left_margin, defaultMargin);
            this.smallRectRightMargin = attributes.getDimension(R.styleable.te_beauty_panel_item_selector_rect_right_margin, defaultMargin);
            this.smallRectTopMargin = attributes.getDimension(R.styleable.te_beauty_panel_item_selector_rect_top_margin, defaultMargin);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (width == -1 || height == -1) {
            ...
            rect2 = new RectF(smallRectLeftMargin, smallRectTopMargin, smallRoundRectWidth + smallRectLeftMargin, smallRoundRectWidth + smallRectTopMargin);
        }
