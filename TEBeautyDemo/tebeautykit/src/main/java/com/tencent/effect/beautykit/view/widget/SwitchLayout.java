...
public class SwitchLayout extends LinearLayout {
    ...
    private void initViews(Context context) {
        ...
        LayoutParams leftLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LayoutParams rightLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    public void check(int checked_item) {
        if (SWITCH_LEFT_CHECKED == checked_item) {
            this.leftTextView.callOnClick();
        } else if (SWITCH_RIGHT_CHECKED == checked_item) {
            this.rightTextView.callOnClick();
        }
        this.currentCheckedItem = checked_item;
    }
     ...
     * 设置控件总的背景，选中模块的背景
     *
     * @param bgDrawable       控件的大背景
     * @param checkedDrawable  选中区域的背景
     * @param textCheckedColor 选中文字的颜色
     * @param textCommonColor  未选中文字的颜色
     */
    public void setColor(@DrawableRes int bgDrawable, @DrawableRes int checkedDrawable, @ColorRes int textCheckedColor, @ColorRes int textCommonColor) {
