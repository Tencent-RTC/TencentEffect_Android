...
public class TETemplatePanelView extends FrameLayout {
    ...
    private void initViews(Context context) {
        ...
        this.templateDetailPanel.setRightBottomBtnInfo(R.drawable.te_beauty_template_panel_edit_icon, R.string.te_beauty_template_panel_edit_btn_name, TEDetailPanel.TE_PANEL_VIEW_EXPAND_TYPE);
        this.templateDetailPanel.setLeftBottomBtnInfo(R.drawable.te_beauty_panel_view_folded_icon, R.string.te_beauty_panel_view_folded_btn_txt, TEDetailPanel.TE_PANEL_VIEW_EXPAND_TYPE);
        this.templateDetailPanel.setLeftBottomBtnInfo(R.drawable.te_beauty_panel_view_expand_icon, R.string.te_beauty_panel_view_expand_btn_txt, TEDetailPanel.TE_PANEL_VIEW_FOLDED_TYPE);
        this.templateDetailPanel.showBottomBtn(true, true, TEDetailPanel.TE_PANEL_VIEW_EXPAND_TYPE);
        this.templateDetailPanel.showBottomBtn(true, false, TEDetailPanel.TE_PANEL_VIEW_FOLDED_TYPE);
        ...
        this.editView.setRightBottomBtnInfo(0, R.string.te_beauty_template_panel_edit_back_name, TEDetailPanel.TE_PANEL_VIEW_EXPAND_TYPE);
        this.editView.showBottomBtn(true, true, TEDetailPanel.TE_PANEL_VIEW_EXPAND_TYPE);
    ...
    public void showView(@NonNull TEBeautyTemplateProvider templateProvider, @NonNull TEBeautyTemplateEditProvider editProvider, TEPanelViewCallback listener) {
    ...
    private void onShowEditView() {
        ...
        if (teParamList != null && teParamList.size() != 0) {
            ...
            this.editProvider.forceRefreshPanelData(getContext());  //强制刷新数据
