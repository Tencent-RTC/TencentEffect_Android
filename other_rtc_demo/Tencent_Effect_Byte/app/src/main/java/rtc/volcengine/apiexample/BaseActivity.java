...
public class BaseActivity extends AppCompatActivity {
    ...
    public String requestRoomToken(String roomId) {
        if (TextUtils.isEmpty(LicenseConstant.APP_ID) || TextUtils.isEmpty(LicenseConstant.APP_KEY)) {
            return "";
        }
        AccessToken token = new AccessToken(LicenseConstant.APP_ID, LicenseConstant.APP_KEY, roomId, localUid);
