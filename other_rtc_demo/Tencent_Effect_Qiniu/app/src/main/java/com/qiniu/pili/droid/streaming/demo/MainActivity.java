...
import com.tencent.effect.demo.xmagic.LicenseConstant;
...
public class MainActivity extends FragmentActivity {
    ...
    private void checkLicense() {
        TEProgressDialog teProgressDialog = TEProgressDialog.createDialog(this);
        teProgressDialog.show();
        TEBeautyKit.setupSDK(this.getApplicationContext(), LicenseConstant.mXMagicLicenceUrl, LicenseConstant.mXMagicKey, (i,s) -> {
            runOnUiThread(() -> {
                ...
                if (i == LicenseConstant.AUTH_STATE_SUCCEED) {
                    Log.e(TAG, "license check success");
                } else {
                    Log.e(TAG, "te license check is failed,please checked  " + i);
                }
            });
        });
    }
